...
def LoadDataset(fold_num): 
    ...
    trainDataset = seqData(datapath='/root/trainval_el_fold10/el_train_fold{}.csv'.format(fold_num))
    valDataset = seqData(datapath='/root/trainval_el_fold10/el_val_fold{}.csv'.format(fold_num))

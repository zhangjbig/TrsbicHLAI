...
class BA_Model(nn.Module):
    ...
    def forward(self, hla_inputs, pep_inputs):
        ...
        y_ba = self.predict(x_re2)
                        
        return y_ba, hla2pep_attns, pep2hla_attns, hla_enc_self_attns, pep_enc_self_attns, x_fc1, x_bn1, x_re1, x_dp1, x_fc2, x_bn2, x_re2, outputs